...
public class COTest_DErand2 {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i<parameterRandomizationTimes; i++) {
			...
			//Solve the problem for a predefinend number of times
			for(int j = 0; j<problemSolutionTimes; j++) {
				
				ArrayList<DEIndividual> population = OptimizationBuilder.runContinuousOptimization_DErand2(problemB, populationSize, maxGenerations, F, crossoverRate);
