...
public class COTest_DEcurToBest1 {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i<parameterRandomizationTimes; i++) {
			...
			for(int j = 0; j<problemSolutionTimes; j++) {
				...
				ArrayList<DEIndividual> population = OptimizationBuilder.runContinuousOptimization_DEcurToBest1(problemB, populationSize, maxGenerations, F, crossoverRate);
